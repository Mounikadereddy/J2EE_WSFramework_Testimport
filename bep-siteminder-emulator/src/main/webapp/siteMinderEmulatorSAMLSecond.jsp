...
<body>
	...
	<div id="pagecell1">
		...
		<div id="content">
			<div class="story">
				<html:form method="post" action="siteMinderEmulatorSAMLSecond.do">
						...
						<tr>
							<td width="30%">
								<table align="center" bgcolor="#EAEAEA" width="100%" border=0
									...
									<tr>
										<td width="30%" align="right"><b><font size="2.5" color="#336699">Session
													Id:</font></b></td>
										<td align="left"><html:text property="sessionId" /></td>
									</tr>
								</table>
							</td>
							<td>
