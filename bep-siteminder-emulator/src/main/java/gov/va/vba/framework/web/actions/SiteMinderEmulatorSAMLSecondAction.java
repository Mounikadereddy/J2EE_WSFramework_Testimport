 ...
 * 
 */
public class SiteMinderEmulatorSAMLSecondAction extends BaseAction  {

	private static Logger logger=Logger.getLogger(SiteMinderEmulatorSAMLSecondAction.class.getName());
	...
	public ActionForward executeAction(ActionMapping mapping,
		...
		logger.debug("SiteMinderEmulatorSAMLSecondAction::Module Prefix:- " + mapping.getModuleConfig().getPrefix());
		logger.debug("SiteMinderEmulatorSAMLSecondAction::Mapping path:- " + mapping.getPath());	
        ...
        String targetURL = "http://localhost:7001/bep/security/SSOParameterProcessor.jsp?appid="+appName+"&SMPORTALSTATE=U0FNTFJlcXVlc3Q9bFpKTlQlMkJNd0VJYiUyRml1"; 
