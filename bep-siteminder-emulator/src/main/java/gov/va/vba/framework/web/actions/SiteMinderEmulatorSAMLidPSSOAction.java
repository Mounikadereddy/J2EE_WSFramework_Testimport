 ...
 * 
 */
public class SiteMinderEmulatorSAMLidPSSOAction extends BaseAction  {

	private static Logger logger=Logger.getLogger(SiteMinderEmulatorSAMLidPSSOAction.class.getName());
	...
	public ActionForward executeAction(ActionMapping mapping,
		...
		logger.debug("SiteMinderEmulatoridPSSOAction::Module Prefix:- " + mapping.getModuleConfig().getPrefix());
		logger.debug("SiteMinderEmulatoridPSSOAction::Mapping path:- " + mapping.getPath());	
