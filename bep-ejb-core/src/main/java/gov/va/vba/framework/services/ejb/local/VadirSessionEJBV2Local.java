...
@Stateless(name="VadirSessionEJBV2Local")
...
public class VadirSessionEJBV2Local implements VadirSessionV2 {

	private static Logger logger=Logger.getLogger(VadirSessionEJBV2Local.class);
	@Override
