...
import gov.va.vba.framework.services.TuxedoServiceLocalV3;
...
@Stateless(name = "TuxedoServiceV3Local")
@TransactionTimeoutSeconds(3600)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
@TransactionManagement(TransactionManagementType.CONTAINER)
@Local(TuxedoServiceLocalV3.class)
@CallByReference
public class TuxedoSessionEJBV3Local extends GenericService implements TuxedoServiceV3 {
	...
	private static Logger logger = Logger.getLogger(TuxedoSessionEJBV3Local.class);
	 ...
	 * @version
	 */
	public TuxedoSessionEJBV3Local() {
	...
	public String getSensitiveLevel(String ssn, ParticipantType participant,
		...
		logger
				.debug("TuxedoSessionEJBV3Local::getSensitiveLevel. Invoked Bus Interf: "
						+ ctx.getInvokedBusinessInterface().getSimpleName());
	...
	public String createVeteran(String inputData, AuditContext auditContext,
		...
		logger
				.debug("TuxedoSessionEJBV3Local::createVeteran(). Invoked Bus Interf: "
						+ ctx.getInvokedBusinessInterface().getSimpleName());
		TuxParams tuxParams = new TuxParams();
	...
	public TypedBuffer execute(String serviceName, TypedFML32 buffer, boolean transaction, AuditContext auditContext, 
		...
		logger.debug("TuxedoSessionEJBV3Local::execute(). Invoked Bus Interf: " + ctx.getInvokedBusinessInterface().getSimpleName());
		logger.debug("TuxedoSessionEJBV3Local: Tuxedo Connector execute - "+serviceName+" by "+this.ctx.getCallerPrincipal().getName());
