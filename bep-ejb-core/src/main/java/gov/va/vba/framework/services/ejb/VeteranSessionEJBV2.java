...
@Stateless(mappedName="VeteranSessionEJBV2")
@Local(VeteranSessionLocalV2.class)
@Remote(VeteranSessionRemoteV2.class)
public class VeteranSessionEJBV2 implements VeteranSessionV2 {
