 ...
 */
public class CorrespondenceServiceException extends BaseException {
	 ...
	 * @version	
	 */
	public CorrespondenceServiceException(String message, Throwable cause) {
	 ...
	 * @version	
	 */
	public CorrespondenceServiceException(Throwable cause) {
