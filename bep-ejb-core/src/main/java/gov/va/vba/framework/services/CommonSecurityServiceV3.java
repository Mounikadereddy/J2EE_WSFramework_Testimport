...
public interface CommonSecurityServiceV3 extends CommonSecurityServiceV2 {	
     ...
     * @since	Dec 9, 2010
     */
    TuxedoSecurityProfile getSecurityProfileByParticipantId(String participantId, ServiceVO vo, AuditContext auditContext, Map extensions) throws TuxedoException;

    /**
     * Get the CssUser information from the DataSource, specifically the stations associated to the User and Application
     * @param participantId CSS User
     ...
     */
    CssUser getCssUserStationsByParticipantId(String participantId, String applicationName, AuditContext auditContext)  throws CssUserRepositoryException, CssUserRepositoryUnknownException;
