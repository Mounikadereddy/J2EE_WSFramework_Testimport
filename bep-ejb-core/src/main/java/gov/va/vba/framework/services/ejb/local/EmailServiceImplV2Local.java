...
import gov.va.vba.framework.services.EmailServiceLocalV2;
...
@Stateless(name = "EmailServiceV2Local")
@TransactionAttribute(TransactionAttributeType.REQUIRED)
@TransactionManagement(TransactionManagementType.CONTAINER)
@Local(EmailServiceLocalV2.class)
@CallByReference
public class EmailServiceImplV2Local implements EmailServiceV2 {
  private static Logger logger = Logger.getLogger(EmailServiceImplV2Local.class.getName());
