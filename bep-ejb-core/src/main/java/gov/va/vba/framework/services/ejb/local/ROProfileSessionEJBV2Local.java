...
@Stateless(name="ROProfileSessionEJBV2Local")
@TransactionTimeoutSeconds(90)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
@TransactionManagement(TransactionManagementType.CONTAINER)
@Local(ROProfileSessionLocalV2.class)
@CallByReference
public class ROProfileSessionEJBV2Local implements ROProfileSessionV2 {
	...
	private static Logger logger=Logger.getLogger(ROProfileSessionEJBV2Local.class);
