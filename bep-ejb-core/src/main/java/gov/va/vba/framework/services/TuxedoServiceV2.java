...
public interface TuxedoServiceV2 {
	 ...
	 * @since Dec 9, 2010
	 */
	String execute(ServiceVO serviceVo, AuditContext auditContext,
			Map extensions) throws TuxedoException;
	/*
	 * overloads execute adding transaction parameter
	 */
	String execute(ServiceVO serviceVo, boolean transaction, AuditContext auditContext,
			Map extensions) throws TuxedoException;

	/*
	 * overloads execute adding transactionMode parameter
	 */
	String execute(ServiceVO serviceVo, int transactionMode, AuditContext auditContext,
			Map extensions) throws TuxedoException;
	 ...
	 * @return TypedBuffer
	 * @throws TuxedoException
	 * @see gov.va.vba.framework.services.TuxedoServiceV2#execute(gov.va.vba.framework.domain.vo.ServiceVO.TuxedoService,
	 *      weblogic.wtc.jatmi.TypedFML32, AuditContext, Map)
	 * @since Dec 9, 2010
	 */
	TypedBuffer execute(String serviceName, TypedBuffer buffer,
			AuditContext auditContext, Map extensions)
			throws TuxedoException;

	/*
	 * overloads execute adding transaction parameter
	 */
	TypedBuffer execute(String serviceName, TypedBuffer buffer, boolean transaction,
			AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * overloads execute adding transactionMode parameter
	 */
	TypedBuffer execute(String serviceName, TypedBuffer buffer, int transactionMode,
			AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String getVeteranData(String portalId, long key,
			String fileNum, boolean veteranSelf, boolean serviceNumIndicator,
			AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String createCorpClaim(String stationId, String portalId, long key,
			String inputData, AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String executePIFinquiry(String portalId, long key, String fileNum,
	 ...
	 * @since Dec 9, 2010
	 */
	String executeSurvivingSpouseInquiry(String portalId, long key,
			String fileNum, AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String getCorpFlashes(String portalId, long key, String fileNum,
			AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String createCorpFlashes(String portalId, long key, String fileNum,
			String[] flashes, AuditContext auditContext, Map extensions)
			throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String getSensitiveLevel(String portalId, long key, String ssn,
			ParticipantType participant, AuditContext auditContext,
			Map extensions) throws TuxedoException;
	 ...
	 * @since Dec 9, 2010
	 */
	String getClaimantPaymentHistory(String portalId, String key,
			String inputData, AuditContext auditContext, Map extensions)
			throws TuxedoException;
}
