...
/**
 * The persistent class for the PARENT_MARTL_STATUS_DECN database table.
 * 
 * @author BEA Workshop
 */
@Entity()
@Table(name="PARENT_MARTL_STATUS_DECN")
public class ParentMartlStatusDecn implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private ParentMartlStatusDecnPK compId;
	private Long decnId;
	private java.sql.Timestamp eventDt;
	private java.sql.Timestamp invldDecnDt;
	private String parentMartlStatusTypeCd;
	private Award award;
	...
	@EmbeddedId
	public ParentMartlStatusDecnPK getCompId() {
		return this.compId;
	}
	public void setCompId(ParentMartlStatusDecnPK compId) {
		this.compId = compId;
	}
	...
	@Basic()
	@Column(name="PARENT_MARTL_STATUS_TYPE_CD", nullable=false, length=12)
	public String getParentMartlStatusTypeCd() {
		return this.parentMartlStatusTypeCd;
	}
	public void setParentMartlStatusTypeCd(String parentMartlStatusTypeCd) {
		this.parentMartlStatusTypeCd = parentMartlStatusTypeCd;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ParentMartlStatusDecn)) {
			return false;
		}
		ParentMartlStatusDecn castOther = (ParentMartlStatusDecn)other;
