...
/**
 * The persistent class for the MLTY_SEPRTN_PAY database table.
 * 
 * @author BEA Workshop
 */
@Entity()
@Table(name="MLTY_SEPRTN_PAY")
public class MltySeprtnPay implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private MltySeprtnPayPK compId;
	private double grossAmt;
	private Double lessFedTaxAmt;
	private java.sql.Date rcptDt;
	private String seprtnPayTypeCd;
	...
	@EmbeddedId
	public MltySeprtnPayPK getCompId() {
		return this.compId;
	}
	public void setCompId(MltySeprtnPayPK compId) {
		this.compId = compId;
	}
	...
	@Basic()
	@Column(name="SEPRTN_PAY_TYPE_CD", length=12)
	public String getSeprtnPayTypeCd() {
		return this.seprtnPayTypeCd;
	}
	public void setSeprtnPayTypeCd(String seprtnPayTypeCd) {
		this.seprtnPayTypeCd = seprtnPayTypeCd;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MltySeprtnPay)) {
			return false;
		}
		MltySeprtnPay castOther = (MltySeprtnPay)other;
