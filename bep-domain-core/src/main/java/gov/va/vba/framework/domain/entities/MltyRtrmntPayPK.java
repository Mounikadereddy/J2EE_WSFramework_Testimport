...
/**
 * The primary key class for the MLTY_RTRMNT_PAY database table.
 * 
 * @author BEA Workshop
 */
@Embeddable()
public class MltyRtrmntPayPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private Integer lineItemNbr;
	private Long ptcpntId;

    public MltyRtrmntPayPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MltyRtrmntPayPK)) {
			return false;
		}
		MltyRtrmntPayPK castOther = (MltyRtrmntPayPK)other;
