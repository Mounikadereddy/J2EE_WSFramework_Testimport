...
public class GroupAccess implements Serializable {
	...
	@EmbeddedId
	public GroupAccessPK getCompId() {
		return this.compId;
	}
	public void setCompId(GroupAccessPK compId) {
		this.compId = compId;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof GroupAccess)) {
			return false;
		}
		GroupAccess castOther = (GroupAccess)other;
