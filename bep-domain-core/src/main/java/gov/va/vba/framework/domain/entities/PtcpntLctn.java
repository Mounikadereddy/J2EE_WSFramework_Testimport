...
/**
 * The persistent class for the PTCPNT_LCTN database table.
 * 
 * @author BEA Workshop
 */
@Entity()
@Table(name="PTCPNT_LCTN")
public class PtcpntLctn implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private PtcpntLctnPK compId;
	...
	@EmbeddedId
	public PtcpntLctnPK getCompId() {
		return this.compId;
	}
	public void setCompId(PtcpntLctnPK compId) {
		this.compId = compId;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PtcpntLctn)) {
			return false;
		}
		PtcpntLctn castOther = (PtcpntLctn)other;
