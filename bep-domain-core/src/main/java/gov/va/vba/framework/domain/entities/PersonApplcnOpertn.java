...
/**
 * The persistent class for the PERSON_APPLCN_OPERTN database table.
 * 
 * @author BEA Workshop
 */
@Entity()
@Table(name="PERSON_APPLCN_OPERTN")
public class PersonApplcnOpertn implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private PersonApplcnOpertnPK compId;
	private String asgndValueTxt;
	private Date createDt;
	private ApplcnOpertnRule applcnOpertnRule;
	private ApplcnPersonRole applcnPersonRole;
	...
	@EmbeddedId
	public PersonApplcnOpertnPK getCompId() {
		return this.compId;
	}
	public void setCompId(PersonApplcnOpertnPK compId) {
		this.compId = compId;
	}
	...
	public ApplcnPersonRole getApplcnPersonRole() {
		return this.applcnPersonRole;
	}
	public void setApplcnPersonRole(ApplcnPersonRole applcnPersonRole) {
		this.applcnPersonRole = applcnPersonRole;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PersonApplcnOpertn)) {
			return false;
		}
		PersonApplcnOpertn castOther = (PersonApplcnOpertn)other;
