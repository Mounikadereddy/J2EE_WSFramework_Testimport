...
/**
 * The primary key class for the MLTY_SSB_PAY database table.
 * 
 * @author BEA Workshop
 */
@Embeddable()
public class MltySsbPayPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MltySsbPayPK)) {
			return false;
		}
		MltySsbPayPK castOther = (MltySsbPayPK)other;
