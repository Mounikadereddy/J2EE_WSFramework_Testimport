...
/**
 * The primary key class for the MLTY_SEPRTN_PAY database table.
 * 
 * @author BEA Workshop
 */
@Embeddable()
public class MltySeprtnPayPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private Integer lineItemNbr;
	private Long ptcpntId;

    public MltySeprtnPayPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MltySeprtnPayPK)) {
			return false;
		}
		MltySeprtnPayPK castOther = (MltySeprtnPayPK)other;
