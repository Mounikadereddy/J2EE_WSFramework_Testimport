...
/**
 * The primary key class for the STN_APPLCN_ROLE database table.
 * 
 * @author BEA Workshop
 */
@Embeddable()
public class StnApplcnRolePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof StnApplcnRolePK)) {
			return false;
		}
		StnApplcnRolePK castOther = (StnApplcnRolePK)other;
