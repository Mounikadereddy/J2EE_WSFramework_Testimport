...
/**
 * The primary key class for the RBA_PRFIL database table.
 * 
 * @author BEA Workshop
 */
@Embeddable()
public class RbaPrfilPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RbaPrfilPK)) {
			return false;
		}
		RbaPrfilPK castOther = (RbaPrfilPK)other;
