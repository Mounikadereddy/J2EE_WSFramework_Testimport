...
/**
 * The persistent class for the MLTY_SEVRNC_PAY database table.
 * 
 * @author BEA Workshop
 */
@Entity()
@Table(name="MLTY_SEVRNC_PAY")
public class MltySevrncPay implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private MltySevrncPayPK compId;
	...
	@EmbeddedId
	public MltySevrncPayPK getCompId() {
		return this.compId;
	}
	public void setCompId(MltySevrncPayPK compId) {
		this.compId = compId;
	}

	@Basic()
	@Column(name="DSBLTY_TXT", length=32)
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MltySevrncPay)) {
			return false;
		}
		MltySevrncPay castOther = (MltySevrncPay)other;
