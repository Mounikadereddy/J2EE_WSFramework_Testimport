...
<meta name=Description
	content="This page displays errors identifued after a succesfull authentication due to authorization business rules for the user and application." />
				...
				<div class="panel-body info_panel_body">
					...
					<div class="row">
						<div class="col-md-12">
							<br />
							<p>
								<div class="info_header">CSS Authorization Failed</div>
								<br />
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<c:if test="${not empty errorMessage}">
								<div class="row">
									<div class="col-md-12">
										<b class="red-error-text">Application Errors:</b> ${errorMessage}
									</div>
							</div>
							</c:if>
							
							<br /> <br />
							<a href='${tryAgainURL}'>Try to login again</a>
							<br /> <br />
