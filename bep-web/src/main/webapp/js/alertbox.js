...
(function($) {
  ...
  main = {
    ...
    messageBox: function(type, message, properties, input, okTitle) {
        ...
        {
            $('#'+this.options.name+'-Buttons').append('<input id="BoxAlertBtnOk" type="submit" title="' + ((!!okTitle) ? okTitle : "") + '" alt="' + ((!!okTitle) ? okTitle : "") + '"/>');
            
            $('#BoxAlertBtnOk').val(properties.textBoxBtnOk).css({'width':80});
    ...
    preloadImages: function() {
      ...
      img[0].src = this.Box.css('background-image').replace(new RegExp(strPattern, 'gi'), "$1");
      img[1].src = this.InBox.css('background-image').replace(new RegExp(strPattern, 'gi'), "$1");
      img[2].src = this.Contenedor.css('background-image').replace(new RegExp(strPattern, 'gi'), "$1");
    },
    ...
    */		
    alert: function(message, properties, okButtonTitle) {
      this.messageBox('alert', message, properties, null, okButtonTitle);
    },
