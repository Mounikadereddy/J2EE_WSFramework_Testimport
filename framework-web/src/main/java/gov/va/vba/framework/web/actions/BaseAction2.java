...
import gov.va.vba.framework.web.security.SecurityException;
 ...
 */
public abstract class BaseAction2 extends ActionSupport implements ServletRequestAware, ServletResponseAware{
	
	private static Logger logger=Logger.getLogger(BaseAction2.class.getName());
	...
	public String execute() throws Exception {
		...
		try {			
			log("Framework BaseAction: Executing mapping: "+request.getPathInfo());
			forwardPage = executeAction( request, response, 
					(UserContext)request.getSession(false).getAttribute(SecurityFilter.USER_CONTEXT));
		}
	 ...
	 * @throws	Exception
	 */
	public abstract String executeAction(HttpServletRequest req,
