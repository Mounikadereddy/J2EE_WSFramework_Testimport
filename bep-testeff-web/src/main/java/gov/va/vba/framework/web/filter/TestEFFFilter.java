...
public final class TestEFFFilter extends BaseFilter implements Filter {
	
	private final static Logger logger=Logger.getLogger(TestEFFFilter.class.getName());
	...
	public void doFilter(ServletRequest sreq, ServletResponse sresp,
		...
		try {		
			if (_filterConfig == null)
				...
				logger.debug("Test EFF  Filter Completed");
	...
	static void logRequest(HttpServletRequest req) {
		...
		logger.debug("Framework Test EFF Webservice Filter is processing a "+req.getMethod()+
